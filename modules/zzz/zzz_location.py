...
# 16:9窗口模式
    ...
    print("16:9窗口模式")
    x_initial_A, y_initial_A, x_offset_A, y_offset_A = (
        300 / 1920 * w_width + w_left,
        (380 - 43) / 1080 * w_hight + SCALE * 24 + w_top,
        142 / 1920 * w_width,
        181 / 1080 * w_hight)
    x_left_A, x_right_A, y_top_A, y_bottom_A = (
        194 / 1920 * w_width + w_left,
        336 / 1920 * w_width + w_left,
        (264 - 43) / 1080 * w_hight + SCALE * 24 + w_top,
        (445 - 43) / 1080 * w_hight + SCALE * 24 + w_top)
    x_grab_A, y_grab_A, w_grab_A, h_grab_A = (
        [1401 / 1920 * w_width + w_left, 1401 / 1920 * w_width + w_left],
        [(317 - 43- 60) / 1080 * w_hight + SCALE * 24 + w_top, (484 - 43 - 60) / 1080 * w_hight + SCALE * 24 + w_top],
        [263 / 1920 * w_width, 448 / 1920 * w_width],
        [167 / 1080 * w_hight, 387 / 1080 * w_hight])
    row_A, col_A = (4, 8)

    x_initial_B, y_initial_B, x_offset_B, y_offset_B = (
        170 / 1920 * w_width + w_left,
        (250 - 43) / 1080 * w_hight + SCALE * 24 + w_top,
        130 / 1920 * w_width,
        170 / 1080 * w_hight)
    x_left_B, x_right_B, y_top_B, y_bottom_B = (
        76 / 1920 * w_width + w_left,
        206 / 1920 * w_width + w_left,
        (156 - 43) / 1080 * w_hight + SCALE * 24 + w_top,
        (326 - 43) / 1080 * w_hight + SCALE * 24 + w_top)
    x_grab_B, y_grab_B, w_grab_B, h_grab_B = (
        [600 / 1920 * w_width + w_left],
        [(146 - 43) / 1080 * w_hight + SCALE * 24 + w_top],
        [394 / 1920 * w_width],
        [485 / 1080 * w_hight])
    row_B, col_B = (5, 4)
