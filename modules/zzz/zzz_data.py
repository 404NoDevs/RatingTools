...
class Data(BaseData):
    def __init__(self):
        ...
        self.mainAttrType = {
            "分区4": ["生命值", "攻击力", "防御力", "生命值百分比", "攻击力百分比", "防御力百分比",  "暴击率", "暴击伤害", "异常精通"],
            "分区5": ["生命值", "攻击力", "防御力", "生命值百分比", "攻击力百分比", "防御力百分比",  "穿透率", "物理伤害加成", "火属性伤害加成", "冰属性伤害加成", "电属性伤害加成", "以太伤害加成"],
            "分区6": ["生命值", "攻击力", "防御力", "生命值百分比", "攻击力百分比", "防御力百分比",  "异常掌控", "冲击力", "能量自动回复"],
        }
