...
class Data(BaseData):
    def __init__(self):
        ...
        self.mainAttrType = {
            "时之沙": ["生命值百分比", "攻击力百分比", "防御力百分比", "元素精通", "元素充能效率"],
            "空之杯": ["生命值百分比", "攻击力百分比", "防御力百分比", "元素精通", "物理伤害加成", "火元素伤害加成", "雷元素伤害加成", "水元素伤害加成", "草元素伤害加成", "风元素伤害加成", "岩元素伤害加成", "冰元素伤害加成"],
            "理之冠": ["生命值百分比", "攻击力百分比", "防御力百分比", "元素精通", "暴击率", "暴击伤害", "治疗加成"],
        }
        ...
        self.evaluate = [
            (59.4 * 0.8, (230, 179, 34), "优秀"),
            (59.4 * 0.7, (255, 217, 0), "良好"),
            (59.4 * 0.6, (163, 224, 67), "及格"),
            (59.4 * 0.3, (238, 121, 118), "不及格"),
            (59.4 * 0.0, (255, 0, 0), "无用")
        ]
