...
class Data(BaseData):
    def __init__(self):
        ...
        self.mainAttrType = {
            ...
            "连结绳": ["生命值百分比", "攻击力百分比", "防御力百分比", "击破特攻", "能量恢复效率"]
        }
        ...
        self.evaluate = [
            (52.4 * 0.90, (230, 179, 34), "优秀"),
            (52.4 * 0.75, (255, 217, 0), "良好"),
            (52.4 * 0.60, (163, 224, 67), "及格"),
            (52.4 * 0.30, (238, 121, 118), "不及格"),
            (52.4 * 0.00, (255, 0, 0), "急需替换")
        ]
